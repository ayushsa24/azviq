                                        ...
                                        <div className="flex-1 flex items-center justify-center py-1 overflow-hidden">
                                            <div className="relative">
                                                {(() => {
                                                    ...
                                                    return <ClipboardCheck className="w-10 h-10 text-[#545454] dark:text-[#7D7D7D] group-hover:text-black dark:group-hover:text-white transition-all duration-300 transform group-hover:scale-110" strokeWidth={1.5} />;
                                                })()}
                                            </div>
                                        </div>
