                ...
                <form onSubmit={handleCreate} className="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-[#F5F5F5] dark:bg-[#1A1A1A] border border-[#CFCFCF] dark:border-[#545454] rounded-lg px-4 py-3 text-[#252525] dark:text-[#CFCFCF] placeholder-[#545454] dark:placeholder-[#7D7D7D] focus:outline-none focus:border-[#7D7D7D] transition-colors"
                        />
                    </div>
