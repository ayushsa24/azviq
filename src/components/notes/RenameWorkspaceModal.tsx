                ...
                <form onSubmit={handleRename} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-[#F5F3EF] dark:bg-[#1A1A1A] border border-[#E8E5E0] dark:border-[#545454] rounded-lg px-4 py-2.5 text-[#252525] dark:text-white placeholder-[#545454] dark:placeholder-[#7D7D7D] focus:outline-none focus:border-[#7D7D7D] transition-colors"
                            autoFocus
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#F5F3EF] dark:bg-[#1A1A1A] border border-[#E8E5E0] dark:border-[#545454] rounded-lg px-4 py-2.5 text-[#252525] dark:text-white placeholder-[#545454] dark:placeholder-[#7D7D7D] focus:outline-none focus:border-[#7D7D7D] transition-colors resize-none h-24"
                        />
                    </div>
