...
export function RenameWorkspaceModal({ isOpen, onClose, onSuccess, workspace }: RenameWorkspaceModalProps) {
    ...
    return (
        <Modal open={isOpen} onClose={onClose} title="Rename Workspace">
                ...
                <form onSubmit={handleRename} className="space-y-5">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`flex-[1.5] py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${
                                !isLoading
