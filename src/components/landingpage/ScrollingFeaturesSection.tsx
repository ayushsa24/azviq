...
const STICKY_FEATURES = [
  {
    ...
    desc: "A centralized hub for all your academic resources. Organize your semesters, subjects, and study materials in one intuitive, unified space.",
    image: "/landingpage/library.png",
  },
  {
    title: "AI-Powered Notes",
    desc: "Take smart notes that understand your context. Generate summaries, ask questions directly from your notes, and turn concepts into flashcards instantly.",
    image: "/landingpage/notes.png",
  },
  {
    title: "Intelligent PDF Reader",
    desc: "Read, highlight, and chat with your PDFs. Our AI analyzes your documents so you can ask complex questions and get instant, cited answers.",
...
export default function ScrollingFeaturesSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (featureSectionRef.current) {
        ...
        const panelHeight = (sectionHeight - viewportHeight) / STICKY_FEATURES.length;
  ...
  return (
    <section ref={featureSectionRef} className="relative w-full bg-white border-t border-black/[0.05]">
            ...
            {STICKY_FEATURES.map((feature, index) => (
              ...
              >
                <div className="flex flex-col gap-1 mb-4">
                  <span className="text-[11px] text-[#6E6E73] uppercase tracking-[0.14em] font-bold">Library Features</span>
