  ...
  return (
    <div className={`min-h-screen flex items-center justify-center transition-colors duration-300 ${
      ...
      <div className={`relative p-8 rounded-2xl shadow-2xl w-full max-w-md backdrop-blur-xl transition-colors duration-300 ${
        ...
        />
        {errors.email && (
          <p className="text-red-500 text-sm mb-4 -mt-2">{errors.email}</p>
        )}
        ...
        <PasswordInput
          ...
          className={`mb-4 ${errors.password ? 'border-red-500 focus:ring-red-500' : ''}`}
        />
        {errors.password && (
          <p className="text-red-500 text-sm mb-4 -mt-2">{errors.password}</p>
        )}
        ...
        <PasswordInput
          ...
          className={`mb-6 ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500' : ''}`}
        />
        {errors.confirmPassword && (
          <p className="text-red-500 text-sm mb-4 -mt-2">{errors.confirmPassword}</p>
        )}
        ...
        <p className={`text-center mt-4 ${
          ...
          <a href="/login" className="text-indigo-500 hover:text-indigo-400 hover:underline transition-colors duration-200">
            Login
          </a>
        </p>
