    ...
    <div className="min-h-screen p-3 mt-[17px]">
      ...
      <div className={`max-w-2xl mx-auto rounded-2xl p-4 transition-colors duration-300 ease-in-out ${theme === 'dark' ? 'bg-[#252525]/90 border border-[#545454]' : 'bg-gray-100 border border-gray-300'
          ...
          <div className="relative overflow-visible">
            {avatarPreview ? (
              <img
                src={avatarPreview}
                alt="Avatar Preview"
                className={`w-24 h-24 rounded-full object-cover border-4 transition-colors duration-300 ease-in-out ${theme === 'dark' ? 'border-[#545454]' : 'border-gray-400'
                  }`}
              />
            ) : form.avatar_url ? (
              <img
              ...
              <div className={`w-24 h-24 rounded-full flex items-center justify-center border-4 transition-colors duration-300 ease-in-out ${theme === 'dark' ? 'bg-[#545454] border-[#545454]' : 'bg-gray-200 border-gray-400'
                }`}>
                <User className={`w-8 h-8 transition-colors duration-300 ease-in-out ${theme === 'dark' ? 'text-[#7D7D7D]' : 'text-gray-500'
                  }`} />
              </div>
            )}
        ...
        <div className="text-center mb-3">
          <h2 className={`text-xl font-semibold transition-colors duration-300 ease-in-out ${theme === 'dark' ? 'text-white' : 'text-gray-800'
            }`}>
            {form.name || 'Your Name'}
          </h2>
          ...
          <div>
            ...
            {editing ? (
              <textarea
                ...
                rows={2}
                className={`w-full p-3 rounded-lg border transition-colors duration-300 ease-in-out ${theme === 'dark'
